...
import cardImageBg11 from '../assets/images/p1.jpeg';
import cardImageBg22 from '../assets/images/p2.jpeg';
import cardImageBg33 from '../assets/images/p3.jpeg';

import cardImageBg1 from '../assets/images/p4.jpeg';
import cardImageBg2 from '../assets/images/p5.jpeg';
...
const HomeCardComponent = () => {
  return (
    <div className="flex flex-col sm:grid md:grid-cols-2 xl:grid-cols-3 gap-5 m-5 p-5 ">
      ...
      />
      <Card
        imageSrc={cardImageBg22}
        title="Dubai Real Estate"
        // price="$ 1,625,000"
      />
      <Card
        imageSrc={cardImageBg33}
        title="Dubai Real Estate"
        // price="$ 1,625,000"
      />
